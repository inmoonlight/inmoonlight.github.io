...
[Previous work에서 사용했던 데이터]()에서 추가로 필터링이 필요했다. 크롤링한 댓글 데이터에 hashing 된 아이디가 포함된 것이 2015년 12월 이후였기 때문이다.
...
<img class="image" src="{{ site.baseurl }}/assets/images/politics_top_user.png" width="70%">
</div>
<br>
...
#### 1.4.1 `user 1` (ratio: 96%)

<div style="text-align:center">
<img class="image" src="{{ site.baseurl }}/assets/images/user1.png" width="90%">
</div>
<br>
...
#### 1.4.2 `user 3` (ratio: 93%)

<div style="text-align:center">
<img class="image" src="{{ site.baseurl }}/assets/images/user3.png" width="90%">
</div>
<br>
